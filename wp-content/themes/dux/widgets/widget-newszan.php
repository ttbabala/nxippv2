...
class widget_newszan extends WP_Widget {

	function widget_newszan() {

		$widget_ops = array( 'classname' => 'widget_newszan', 'description' => '点赞最多的文章' );

		$this->WP_Widget( 'widget_newszan', 'D-聚合文章', $widget_ops );
	...
	function widget( $args, $instance ) {
		...
		echo dtheme_newszan_list( $orderby,$limit,$cat,$img );
...
function dtheme_newszan_list($orderby,$limit,$cat,$img) {
